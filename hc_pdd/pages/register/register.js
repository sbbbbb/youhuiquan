...
Page({
    ...
    register: function(l) {
        ...
        wx.getStorage({
            key: "user",
            success: function(a) {
                var t, o = (t = a.data.detail).openid, e = t.session_key, n = (t = t.userInfo).country, i = t.province, c = t.city, s = t.gender, r = t.nickName, u = t.avatarUrl;
                app.util.request({
                    ...
                    success: function(a) {
                        app.globalData.user_id = a.data.data, "function" == typeof l && l(a.data.data), 
                        wx.reLaunch({
                            url: "../index/index"
                        });
                    }
