...
Page({
    ...
    Headcolor: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                var e = t.data.data.config.title, n = t.data.data.yesno, i = t.data.data.config.shenhe, s = t.data.data.config.text, r = t.data.data.theme, d = t.data.data.config, c = d.enable, u = t.data.data.hongbao, p = t.data.data.hb, l = f.data.hb, h = p.endtime;
                l = 0 == u.status ? u.firstmoney : u.zhuanfamoney, f.setData({
                    search_color: a,
                    share_icon: o,
                    yesno: n,
                    shenhe: i,
    ...
    timetime: function() {
        var d = this.data.hb.e_time - Date.parse(new Date()) / 1e3, c = setInterval(function() {
            var t = d, a = Math.floor(t / 3600 / 24), o = a.toString();
            1 == o.length && (o = "0" + o);
            ...
            1 == r.length && (r = "0" + r), this.setData({
                ...
                countDownMinute: s,
                countDownSecond: r
            }), --d < 0 && (clearInterval(c), this.setData({
                countDownDay: "00",
                countDownHour: "00",
                countDownMinute: "00",
                countDownSecond: "00"
    ...
    mai: function() {
        var t = this;
        0 == t.data.enable ? wx.navigateToMiniProgram({
            appId: t.data.config.zzappid,
            path: "/hc_zhongzhuan/pages/index/index?goods_id=" + t.data.goods_id + "&user_id=" + t.data.user_id + "&client_id=" + t.data.config.client_id + "&client_secret=" + t.data.config.client_secret + "&pid=" + t.data.config.pid,
            extraData: {},
            envVersion: "release",
            success: function(t) {
                console.log("成功");
            ...
            appId: t.data.we_app_info.app_id,
            path: t.data.we_app_info.page_path,
            extraData: {
    ...
    onShareAppMessage: function(t) {
        ...
        return "button" === t.from && console.log(t.target), {
            title: a.data.hongbaoqiy.fenxiangtitle,
            path: "hc_pdd/pages/index/index",
            imageUrl: a.data.hongbaoqiy.fenxiangpic,
            success: function(t) {
                app.util.request({
