...
Page({
    ...
    Headcolor: function() {
        ...
        app.util.request({
            ...
            success: function(a) {
                var t = a.data.data.search_color, e = a.data.data.config.share_icon, i = a.data.data.config.shenhe, o = a.data.data.config, s = a.data.data.is_daili;
                n.setData({
                    search_color: t,
                    share_icon: e,
                    shenhe: i,
