...
Page({
    ...
    register: function(u) {
        ...
        wx.getStorage({
            key: "user",
            success: function(o) {
                var a, n = (a = o.data.detail).openid, t = a.session_key, e = (a = a.userInfo).country, i = a.province, c = a.city, s = a.gender, l = a.nickName, r = a.avatarUrl;
                app.util.request({
                    ...
                    success: function(o) {
                        app.globalData.user_id = o.data.data, "function" == typeof u && u(o.data.data), 
                        wx.reLaunch({
                            url: "../index/index"
                        });
                    }
